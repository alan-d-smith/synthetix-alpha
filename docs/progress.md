...
| 2026-08-29 23:51 | 7 | `portfolio_index_plus_singlename` | SPY+QQQ+AAPL | +15.3% | 0.97 | 0.97 | -2.1% | +0.1% | 180 | **+0.913** | ⚠ correction: sleeves absent for a period were counted as 0% returns instead of being reallocated, so the blend was two-thirds idle before 2020. Sharpe 1.15 holds only on the overlap window, not the full period |
| 2026-08-29 23:51 | 8 | `portfolio_three_sleeve` | SPY+QQQ+AAPL | +14.3% | 0.97 | 0.97 | -2.1% | +0.1% | 258 | **+0.914** | ⚠ correction: same weighting bug. Over the full period the bear-call sleeve adds ~0.001 Sharpe, not the 1.15 -> 1.34 measured on the overlap, because it only trades in a narrow window |

15 improvements across 19 logged evaluations; score -1.180 -> +0.914, mean Sharpe -0.13 -> 0.97.
